...
namespace Pos.Domain.Migrations
{
    ...
    [Migration("20260729100216_AddProductAndCategorySeeds")]
    partial class AddProductAndCategorySeeds
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Pos.Domain.Entities.MemberPromotion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            EndDate = new DateTime(2026, 12, 31, 23, 59, 59, 0, DateTimeKind.Utc),
                            FreeProductId = new Guid("11111111-1111-1111-1111-111111111103"),
                            FreeQuantity = 1,
                            IsActive = true,
                            MinQuantity = 2,
            ...
            modelBuilder.Entity("Pos.Domain.Entities.RoleRoutePermission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("aa111111-1111-1111-1111-111111111127"),
                            CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            IsAllowed = true,
                            RoleId = new Guid("11111111-1111-1111-1111-111111111111"),
                        ...
                        new
                        {
                            Id = new Guid("aa111111-1111-1111-1111-111111111128"),
                            CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            IsAllowed = true,
                            RoleId = new Guid("11111111-1111-1111-1111-111111111111"),
                        ...
                        new
                        {
                            Id = new Guid("aa111111-1111-1111-1111-111111111129"),
                            CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            IsAllowed = true,
                            RoleId = new Guid("11111111-1111-1111-1111-111111111111"),
                        ...
                        new
                        {
                            Id = new Guid("aa111111-1111-1111-1111-111111111130"),
                            CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            IsAllowed = true,
                            RoleId = new Guid("11111111-1111-1111-1111-111111111111"),
